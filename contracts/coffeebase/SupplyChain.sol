    ...
    ConsumerRole
{
    ...
    modifier paidEnough(uint256 _price) {
        require(msg.value >= _price, "Insufficient price given to transaction");
        _;
    }
    ...
    modifier harvested(uint256 _upc) {
        require(
            ...
            "Error: Item state must be 'Harvested'"
        );
        _;
    }
    ...
    modifier processed(uint256 _upc) {
        require(
            ...
            "Error: Item state must be 'Processed'"
        );
        _;
    }
    ...
    modifier packed(uint256 _upc) {
        require(
            ...
            "Error: Item state must be 'Packed'"
        );
        _;
    }
    ...
    modifier forSale(uint256 _upc) {
        require(
            ...
            "Error: Item state must be 'ForSale'"
        );
        _;
    }
    ...
    modifier shipped(uint256 _upc) {
        require(
            ...
            "Error: Item state must be 'Shipped'"
        );
        _;
    }
    ...
    modifier received(uint256 _upc) {
        require(
            ...
            "Error: Item state must be 'Recieved'"
        );
        _;
    }
    ...
    modifier purchased(uint256 _upc) {
        require(
            ...
            "Error: Item state must be 'Purchased'"
        );
        _;
    }
